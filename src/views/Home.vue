<template>
  <div class="home">
    ...
    <PopUpArticle title="Animal, minéral ou végétal?"
    text="Les coraux sont constitués de milliers de 
      petits organismes appelés polybes, 
      principalement formé d’une bouche et 
      d’un estomac.
